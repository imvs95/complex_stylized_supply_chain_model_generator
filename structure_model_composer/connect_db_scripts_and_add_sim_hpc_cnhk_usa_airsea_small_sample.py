...
if __name__ == "__main__":
    db_random = "random_small_sample_cnhk_usa_airsea"
    db_location = "location_model_small_sample_cnhk_usa_airsea"

    constraints_file = "../input/constraints_sc_nodoubleinput_cnhk_usa.json"

    # ## Create random structures
    logging.basicConfig(level=logging.INFO)
    fill_db(n=5, n_structures=2, db_name=r"./databases/" + db_random, constraints_file=constraints_file)
